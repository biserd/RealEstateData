/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5b617839b0c6a98f1e08d7527707bab2)
...
interface __BaseEnv_Env {
	...
	EXTERNAL_API_RATE_LIMIT: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	NODE_ENV: "production";
	DATABASE_ENV: "production";
	APP_BASE_URL: "https://realtorsdashboard.com";
	EMAIL_FROM_ADDRESS: "hello@realtorsdashboard.com";
	EMAIL_FROM_NAME: "Realtors Dashboard";
	ADMIN_EMAIL: "hello@bigappledigital.nyc";
	TURNSTILE_SITE_KEY: "0x4AAAAAAEhj75hc4gIoOsCg";
	USAGE_QUOTA: DurableObjectNamespace<import("./server/worker").UsageQuota>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_ENV" | "APP_BASE_URL" | "EMAIL_FROM_ADDRESS" | "EMAIL_FROM_NAME" | "ADMIN_EMAIL" | "TURNSTILE_SITE_KEY">> {}
}
